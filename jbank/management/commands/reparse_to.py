        ...
        for file in qs.order_by('id'):
            ...
            for data in statements:
                for e in data['records']:
                    ...
                    e2 = StatementRecord.objects.filter(statement__file=file, line_number=0, record_number=e['record_number'],
                                                        archive_identifier=e['archive_identifier'], record_date=e['record_date'],
                                                        value_date=e['value_date'], paid_date=e['paid_date'],
                                                        entry_type=e['entry_type'], record_code=e['record_code'],
                                                        record_description=e['record_description'], receipt_code=e['receipt_code'],
                                                        delivery_method=e['delivery_method'], name=e['name'],
                                                        name_source=e['name_source'], recipient_account_number=e['recipient_account_number'],
                                                        recipient_account_number_changed=e['recipient_account_number_changed'],
                                                        remittance_info=e['remittance_info']).first()
                    if e2:
