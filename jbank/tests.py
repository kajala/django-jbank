...
class Tests(TestCase):
    ...
    def test_x509(self):
        ...
        not_valid_before, not_valid_after = cert.not_valid_before_utc, cert.not_valid_after_utc
        ...
        ref_bytes = b'<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns1="http://model.bxd.fi" xmlns:ns2="http://bxd.fi/CorporateFileService">\n  <SOAP-ENV:Header><wsse:Security xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"><Signature xmlns="http://www.w3.org/2000/09/xmldsig#">\n<SignedInfo>\n<CanonicalizationMethod Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/>\n<SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"/>\n<Reference URI="#id-5522eae8-2371-41f0-9e97-6e759fbf9d24">\n<Transforms>\n<Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/>\n</Transforms>\n<DigestMethod Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"/>\n<DigestValue>izeR0IuDHcex74BW+mVHKWYXc1w=</DigestValue>\n</Reference>\n</SignedInfo>\n<SignatureValue></SignatureValue>\n<KeyInfo>\n<wsse:SecurityTokenReference><wsse:Reference ValueType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3" URI="#id-7dc519b1-e919-4ff7-b8fa-6ec17b26d2fb"/></wsse:SecurityTokenReference></KeyInfo>\n</Signature><wsse:BinarySecurityToken xmlns:ns1="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" ValueType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3" EncodingType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary" ns1:Id="id-7dc519b1-e919-4ff7-b8fa-6ec17b26d2fb">\n</wsse:BinarySecurityToken></wsse:Security></SOAP-ENV:Header><SOAP-ENV:Body xmlns:ns0="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" ns0:Id="id-5522eae8-2371-41f0-9e97-6e759fbf9d24">\n    <ns2:helloWorldin>\n      <ns1:RequestHeader>\n        <ns1:SenderId>12319203</ns1:SenderId>\n        <ns1:RequestId>1</ns1:RequestId>\n        <ns1:Timestamp>2015-02-03T14:30:00+02:00</ns1:Timestamp>\n        <ns1:Language>FI</ns1:Language>\n        <ns1:UserAgent>Kajala WS</ns1:UserAgent>\n        <ns1:ReceiverId>123192031</ns1:ReceiverId>\n      </ns1:RequestHeader>\n    <ns1:ApplicationRequest></ns1:ApplicationRequest>\n    </ns2:helloWorldin>\n  </SOAP-ENV:Body>\n</SOAP-ENV:Envelope>'  # noqa
        self.assertEqual(self.normalize_soap_env(ref_bytes), self.normalize_soap_env(signed_body_bytes))

    def test_x509_data(self):
        with open(os.path.join(settings.BASE_DIR, "data/x509/x509data.xml"), "rb") as fp:
            xml_bytes = fp.read()
        x509_data = etree.fromstring(xml_bytes)
        cert = x509_data.find(etree.QName(zeep.ns.DS, "X509Certificate"))
    ...
    def test_parse_xm(self):
        ReferencePaymentBatchFile.objects.all().delete()
        call_command("parse_xm", "data/xm", verbose=True, auto_create_accounts=True)
        file = ReferencePaymentBatchFile.objects.all().order_by("-id").first()
