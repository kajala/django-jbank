...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='account_number',
            field=jutil.modelfields.SafeCharField(db_index=True, max_length=35, validators=[jutil.validators.iban_validator], verbose_name='account number'),
        ),
        migrations.AlterField(
            model_name='payoutparty',
            name='address',
        ...
        migrations.AlterField(
            ...
            field=jutil.modelfields.SafeCharField(choices=[('0', 'Regular Entry'), ('1', 'Correction Entry')], max_length=1, verbose_name='correction identifier'),
        ),
        migrations.AlterField(
            model_name='referencepaymentrecord',
            name='currency_identifier',
        ...
        migrations.AlterField(
            ...
            field=jutil.modelfields.SafeCharField(choices=[('A', 'From Customer'), ('K', 'From Bank Clerk'), ('J', 'From Bank System')], db_index=True, max_length=1, verbose_name='delivery method'),
        ),
        migrations.AlterField(
            model_name='referencepaymentrecord',
            name='name_source',
            field=jutil.modelfields.SafeCharField(blank=True, choices=[('', 'Not Set'), ('A', 'From Customer'), ('K', 'From Bank Clerk'), ('J', 'From Bank System')], max_length=1, verbose_name='name source'),
        ),
        migrations.AlterField(
            model_name='referencepaymentrecord',
            name='payer_name',
        ...
        migrations.AlterField(
            model_name='referencepaymentrecord',
            name='receipt_code',
            field=jutil.modelfields.SafeCharField(blank=True, choices=[('', ''), ('E', 'Separate'), ('P', 'Separate/Paper')], db_index=True, max_length=1, verbose_name='receipt code'),
        ),
        migrations.AlterField(
            model_name='referencepaymentrecord',
            name='record_type',
        ...
        migrations.AlterField(
            model_name='statementrecord',
            name='entry_type',
            field=jutil.modelfields.SafeCharField(choices=[('1', 'Deposit'), ('2', 'Withdrawal'), ('3', 'Deposit Correction'), ('4', 'Withdrawal Correction')], db_index=True, max_length=1, verbose_name='entry type'),
        ),
        migrations.AlterField(
            model_name='statementrecord',
            name='family_code',
